...
final class Version20190818102553 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reusable_packaging (id SERIAL NOT NULL, restaurant_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, on_hold INT NOT NULL, on_hand INT NOT NULL, tracked BOOLEAN NOT NULL, PRIMARY KEY(id))');
